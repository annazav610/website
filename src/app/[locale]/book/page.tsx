    ...
    <>
      ...
      <section className="pt-4 pb-0 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-[#2e9e6b] text-sm font-semibold uppercase tracking-widest mb-3">{t('scheduleLabel')}</p>
            <h2 className="text-3xl font-bold text-[#1a2e4a] mb-3">{t('scheduleTitle')}</h2>
      ...
      <section className="py-10 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-14">
          <div>
            <h2 className="text-2xl font-bold text-[#1a2e4a] mb-6">{t('expectTitle')}</h2>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 space-y-4">
              ...
              <a href={`mailto:${COACH.email}`} className="flex items-center gap-3 text-sm text-[#1a2e4a] hover:text-[#2e9e6b] transition-colors">
                <Mail size={16} className="text-[#2e9e6b]" />{COACH.email}
              </a>
              <a href={COACH.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-[#1a2e4a] hover:text-[#2e9e6b] transition-colors">
                <ExternalLink size={16} className="text-[#2e9e6b]" />LinkedIn
              </a>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full text-center py-12 gap-4">
                ...
                <h3 className="text-xl font-bold text-[#1a2e4a]">{t('successTitle')}</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" className="w-full flex items-center justify-center gap-2 bg-[#2e9e6b] hover:bg-[#38b27a] text-white font-bold py-3.5 rounded-full transition-all hover:scale-[1.02]">
